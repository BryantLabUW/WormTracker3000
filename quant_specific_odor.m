function [n, nfinal, neutZone]= quant_specific_odor(plotxvals, plotyvals, CportStdLoc)
%% quant_specific_odor includes additional analyses for single-worm odor tracking assays.
%
...
% scoring region
cC = displacement.C<=info.scoringradius ;% if the displacement from control center (aka hypoteneus) is less  than the radius of the scoring region, the worm is within the control scoring zone.
cE = displacement.E<=info.scoringradius ;% if the displacement from experimental center (aka hypoteneus) is less  than the radius of the scoring region, the worm is within the experimental scoring zone.

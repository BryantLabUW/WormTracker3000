...
UID="230804_01" // Name of subfolder containing all the images for a single experimental run (e.g. a single worm). Best practice: this folder is a unique ID corresponding to the experiment/worm
...
call("java.lang.System.gc");
		...
		run("Translate...", "x="+Translate+" y=0 interpolation=None stack"); //If necessary, adjust image so grid aligns to edge of gel
			call("java.lang.System.gc");
		run("Save", "save=[/Volumes/" + Folderpath + "/" + UID + "_processed.tif]"); //Save Image
		close();	
